...
public class DiyDialog {
    ...
    private void init(View view) {
        ...
        // 设置默认透明度0.6f
        this.setDimAmount(0.6f);
        // 设置默认居中显示
        this.setDialogGravity(DiyDialogGravity.GRAVITY_CENTER);
    }
     ...
     */
    public DiyDialog setDialogWidth(int proportion) {
        if (dialog != null) {
     ...
     */
    public DiyDialog setDialogHeight(int proportion) {
        if (dialog != null) {
            Window window = dialog.getWindow();
            if (window != null) {
                WindowManager.LayoutParams lp = window.getAttributes();
     ...
     */
    public DiyDialog setDialogGravity(DiyDialogGravity diyDialogGravity) {
        if (dialog != null) {
            Window window = dialog.getWindow();
